import { ActionRowBuilder, ButtonBuilder, ButtonComponent, ButtonStyle, Component, StringSelectMenuBuilder, StringSelectMenuOptionBuilder } from "discord.js";
...
export async function createProjectButtons(proj){
    ...
    if(proj.previewURL !== ""){
        ...
        response = new ActionRowBuilder().addComponents([repoButton,previewLinkButton,deleteButton])
        return response;
    }
